...
partD = xl_file[70:71].values.tolist()[0][1]
ithProduct = int(partD[partD.find('=')+1:partD.find(',')])
jthProduct = int(partD[partD.rfind('=')+1:])

m.addConstr(XVar[jthProduct-1]*XVar[ithProduct-1] == 0)
